...
import { getMemberById, getMemberPostsById, getMemberPath } from '@src/utils/helper'
...
const Page: NextPage<Props> = (props) => {
  const { id, name, bio, avatarSrc, twitterUsername, githubUsername, websiteUrl } = props.member
