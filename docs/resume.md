...
- JavaScript フレームワークを利用した フロントエンド開発ができる。
...
- プロジェクト概要
  - プロ人材と企業が Web 上でマッチングできるサービスの開発。1 時間からの対面・電話によるビジネス課題の相談が出来るプラットフォームの構築。
- チーム構成
  - ビジネスメンバー：6 人
  - 開発メンバー：3 人
- 担当業務
...
2. toB業務システム新規開発 ( 2019-09 - 2019-11 )
...
- 担当業務
  ...
  - Echo フレームワークを利用した開発。
- 発揮したバリュー
  - 自社で開発したサービスのほとんどが SaaS と API で連携している状況だったので、そのアクセス元をラップするパッケージを作ることでより疎結合な連携にすることができ、より堅牢なアーキテクチャにできるとチームで考え挑戦した。
...
- 担当業務
  - Docker を用いた開発環境の構築。
  - Laravel フレームワークを利用した機能実装、及び DB 設計や構築などの開発業務全般。
...
- プロジェクト概要
  - 医療業界における転職活動や採用活動を Web 上のプラットフォームで行うことができる医療専門求人サービス。
- チーム構成
  - ビジネスメンバー：3 人
